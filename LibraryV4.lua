...
function SolarisLib:New(Config)
    ...
    function SettingsConstructor()
        ...
        general:ToggleSetting("Show Music On Launch", "Shows the music menu when you load DexHub", true, "ShowMusicOnLaunch")
        ...
        appearance:Dropdown("Theme", "The look of the user interface", {"Default", "Discord", "Red", "Green", "Blue"}, "Blue", "Theme")
